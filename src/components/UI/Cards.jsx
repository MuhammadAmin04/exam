...
// import { Link } from "react-router-dom";
import "./style.scss";
// import products from '../../server/db2.jsx'

const Cards = ({state: {image, title, price, discount , id}}) => {
  ...
  return (
		<div>
			<div
				...
				className="card h-[366px] min-w-[260px] border hover:shadow-lg   "
			>
				<img src={image} alt="" className="w-[260px] h-[260px] " />
				<Link to={`/flowers/${id}`}>
					<h2 className="text-[18px] font-medium text-center pt-[20px]">
						{title}
					</h2>
				</Link>
